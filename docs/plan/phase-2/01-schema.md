...
| 00xx | `inv_stock` | `stock_items`, `stock_moves` | **Outstanding.** The general stock half of `inv`: what the storeman issues against an SPK, from a list the BOM proposes and a person confirms (S1, D266). Nothing deducts automatically |
