...
| `09_queue_reconciliation.sql` | **2026-09-24** | read-only: GAP 1 = 35 rows waiting and invisible (Rp 149.082.398, all dated ≥ 2026-09-22), GAP 2 = 7 already decided in the web app |
