...
-- (`docs/sop/`) and John Lau's process knowledge (`0136`) were written from it.
--
...
begin
  ...
  -- Exactly what `ReceiveForm.tsx` sends: the display labels (B5, 0138).
...
begin
  ...
  -- until 0141 (B9, D298): the ledger detail now says 1 lot at the amount paid.
