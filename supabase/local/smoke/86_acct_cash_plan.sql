...
select ops_acct.post_transaction(
  ...
  p_trx_date => ops_core.office_day() - 90);
...
select 'cafe0003-0000-0000-0000-000000000001', 'Sewa kantor', 'OUT', 5000000, 'monthly', 5,
       ...
       to_char(ops_core.office_day() - interval '3 months', 'YYYY-MM'), true,
       'cafe0001-0000-0000-0000-000000000001';
...
select 'cafe0003-0000-0000-0000-000000000002', 'Payroll produksi', 'OUT', 2000000, 'weekly', 5,
       'RECCURING - PAYROLL WEEKLY', to_char(ops_core.office_day() - interval '3 months', 'YYYY-MM'), true,
       'cafe0001-0000-0000-0000-000000000001';
...
select 'cafe0003-0000-0000-0000-000000000003', 'Bonus proyek', 'OUT', 10000000, 'once',
       date_trunc('month', ops_core.office_day())::date + 14,
       'cafe0002-0000-0000-0000-000000000001',
       to_char(ops_core.office_day(), 'YYYY-MM'), true,
       'cafe0001-0000-0000-0000-000000000001';
...
select ops_acct.post_transaction(
  ...
  p_trx_date => date_trunc('month', ops_core.office_day())::date + 4);
...
select ops_acct.post_transaction(
  ...
  p_trx_date => ops_core.office_day());
...
values ('cafe0003-0000-0000-0000-000000000001', to_char(ops_core.office_day() + interval '1 month', 'YYYY-MM'),
...
select 'cafe0003-0000-0000-0000-000000000001', to_char(ops_core.office_day() + interval '2 months', 'YYYY-MM'),
...
insert into ops_acct.cash_overrides (component_id, month, amount, reason, recorded_by)
values ('cafe0003-0000-0000-0000-000000000002', to_char(ops_core.office_day() + interval '3 months', 'YYYY-MM'),
...
declare
  ...
  next_month text := to_char(ops_core.office_day() + interval '1 month', 'YYYY-MM');
  month_after text := to_char(ops_core.office_day() + interval '2 months', 'YYYY-MM');
  december text := to_char(ops_core.office_day() + interval '3 months', 'YYYY-MM');
begin
