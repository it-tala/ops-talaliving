...
-- after `analyze`.
--
-- ── Why it has to be a guard and not just `0127` ─────────────────────────
--
...
-- and `0127` fixes only the tables that existed when it ran.
--
...
begin
  ...
  assert n = 0,
    ...
    || 'table with `analyze ops_x.the_table;` (0127 did this for the ladder as it '
