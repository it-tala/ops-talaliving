...
ALLOWED='ops_core|ops_procure|ops_acct|ops_hr|ops_prod|ops_inv|auth|storage|extensions|graphql|graphql_public|realtime|vault|cron|pg_catalog|pg_temp|information_schema'
