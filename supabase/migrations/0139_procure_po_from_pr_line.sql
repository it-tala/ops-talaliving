-- 0139 — an order knows which request line it buys, and money paid on either
...
comment on column ops_procure.po_lines.pr_line_id is
  ...
  'approved, not on another live order, same unit. Kept on superseded lines. (0139, B7)';
