...
type Mode = ProductMoveInputKind | "count" | "home";
...
export function ProductMoveForm({ rows, mayAdjust, onDone, onCancel }: {
  ...
  const [form, setForm] = useState({
    wo_no: "", product_code: "", batch: "", location: "GUDANG", to_location: "", qty: 0, reason: "", ref_no: "",
  });
  ...
  const needsReason = mode === "sold" || mode === "scrap" || mode === "return";
  const ready = !busy && (
