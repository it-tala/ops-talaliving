...
export const VENDORS: Vendor[] = [
  ...
  /* The process vendors the owner named on Q48: barang mentah, jok, amplas,
     packing. Curated, because these are people the workshop hands goods to —
     a vendor holding twenty of our chair frames is not somebody who wandered
     in off an uncurated nota (W6, D280). */
  { id: "vnd_20", code: "V-0020", name: "CV MEBEL MENTAH SEJAHTERA", aka: ["MEBEL MENTAH"], is_curated: true,
    phone: "0361-471223", address: "Jl. Raya Batubulan 88, Gianyar",
    pic_name: "Ketut Sudarma", pic_phone: "0812-3901-4477",
    bank_account: "BCA 145-0992-118", bank_account_secondary: null,
    npwp: null, supplied_categories: ["jasa"] },
  { id: "vnd_21", code: "V-0021", name: "SANTOSO JOK & INTERIOR", aka: ["SANTOSO JOK"], is_curated: true,
    phone: "0361-733012", address: "Jl. Cokroaminoto 214, Denpasar",
    pic_name: "Bambang Santoso", pic_phone: "0813-3877-9002",
    bank_account: "BCA 145-0663-274", bank_account_secondary: null,
    npwp: null, supplied_categories: ["jasa"] },
  { id: "vnd_22", code: "V-0022", name: "UD AMPLAS BAROKAH", aka: [], is_curated: true,
    phone: null, address: "Jl. Mahendradatta 77, Denpasar",
    pic_name: "Slamet", pic_phone: "0857-2244-8811",
